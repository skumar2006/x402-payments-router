          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-6">
            ...
            <div className="relative h-72 overflow-hidden rounded-2xl bg-gray-100">
              <img 
                ...
                alt="Custom Automations Background" 
                className="pointer-events-none h-full w-full object-cover"
              />
              <div className="absolute bottom-3 left-4 right-4 flex items-center justify-between">
                <div className="-gap-3 flex flex-col">
                  <h2 className="text-left text-base font-medium leading-snug text-white">Custom Automations</h2>
                  <p className="text-left text-sm leading-snug text-gray-100">Ask Flip to create or edit instead</p>
                </div>
                <button 
